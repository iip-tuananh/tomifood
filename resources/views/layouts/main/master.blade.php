...
@import url('https://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,100..900;1,100..900&display=swap');
    ...
    <link rel="preload" as="script" href="{{asset('frontend/js/swiper.js?1676652384879')}}" />
    <script src="{{asset('frontend/js/swiper.js?1676652384879')}} "></script>
    ...
    {{-- <div id="fb-root"></div>
    <script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v18.0&appId=523128539484870&autoLogAppEvents=1" nonce="isCMYLSk"></script> --}}
</head>
...
<body id="body_m">
    <div class="page-body">
        ...
        {{-- @if ($setting->statusImgHeader == 1)
        <a href="{{$setting->linkImgHeader}}" title="{{$setting->imgHeader}}" class="d-md-block d-none">
            <img alt="{{$setting->imgHeader}}" class="lazy loaded" src="{{url('frontend/images/placeholder_1x1.png')}}" data-src="{{$setting->imgHeader}}" data-was-processed="true">
        </a>
        @endif --}}
        ...
        <div onclick="scrollToTop(100);"
            ...
            <img alt="Lên đầu trang"
                src="{{url('frontend/images/to-top-arrow2.png')}}">
        </div>
        <div class="fix-phone p-1 p-lg-2 pt-lg-3 pb-lg-3" id="mb_bar">
            <a href="tel:{{$setting->phone1}}" title="Gọi mua hàng"
            ...
            <a href="https://zalo.me/{{$setting->phone1}}" title="Chat Zalo" target="_blank"
            ...
            {{-- <a href="{{route('compareList')}}" title="So sánh"
                ...
                <span class="position-absolute rounded-circle text-center font-weight-bold comp">{{!empty($compare) ? count($compare) : 0}}</span>
            </a> --}}
        </div>
        
        <div class="toast-container"></div>
        <script src="{{asset('frontend/js/cash.min.js')}}" defer></script>
        <script src="{{asset('frontend/js/axios.min.js')}}" defer></script>
        ...
        <script src="{{asset('frontend/js/mew_search.js')}}" defer></script>
        ...
        <script src="{{asset('frontend/js/compareProduct.js')}}" defer></script>
