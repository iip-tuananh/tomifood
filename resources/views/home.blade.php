...
@endsection
@section('css')
    <link rel="preload" as="style" href="{{ asset('frontend/css/mew_style_index.scss.css?1676652384879') }}"
        type="text/css">
    <link href="{{ asset('frontend/css/mew_style_index.scss.css?1676652384879') }}" rel="stylesheet" type="text/css"
        media="all" />
@endsection
@section('script')
@endsection
    ...
    <div class="contentWarp ">
        ...
        <section class="container mew_mobile_slide mb-4">
                        ...
                        <div class="swiper-wrapper">
                            @foreach ($banner as $item)
                                <div class="swiper-slide text-center">
                                    <a class="d-block w-100" href="{{ $item->link }}" title="{{ $item->link }}">
                                        <img class="d-block img img-cover tuanbaner" src="{{ $item->image }}"
                                            alt="{{ $item->link }}" />
                                    </a>
                                </div>
                            @endforeach
                        ...
                        <div class="swiper-wrapper">
                            @foreach ($BannerAds as $item)
                                <div class="swiper-slide">
                                    <a class="d-block" href="{{ $item->link }}" title="{{ $item->link }}">
                                        <img class="d-block img img-cover img-doc " src="{{ $item->image }}"
                                            alt="{{ $item->link }}" />
                                    </a>
                                </div>
                            @endforeach
                            <div class="swiper-slide">
                                <a class="d-block" href="javascript:void(0);" title="">
                                    <img class="d-block img img-cover img-doc " src="{{ asset('frontend/images/1.gif') }}"
                                        alt="" />
                                </a>
                            </div>
                        </div>
            ...
            <div class="mew_slide_ads swiper-container position-relative" data-aos="fade-up">
                <h2 style="width:100%;text-align:center;color:#fff;padding:5px 0;margin:0 0 15px 0;text-transform:uppercase;font-size:1.1rem"
                    data-aos="zoom-in" class="hieuungmau">
                    <span style="margin-left:10px">☰</span> DANH MỤC SẢN PHẨM
                </h2>
                <div class="swiper-wrapper">
                    @foreach ($categoryhome as $item)
                        <div class="swiper-slide text-center">
                            <a class="d-block w-100 h-100 rounded-10 modal-open category-item-hover position-relative overflow-hidden"
                                ...
                                <picture class="position-relative w-100 m-0 ratio1by16 d-block aspect">
                                    <source media="(min-width: 1200px)" srcset="{{ $item->imagehome }}">
                                    <source media="(min-width: 992px)" srcset="{{ $item->imagehome }}">
                                    <source media="(max-width: 569px)" srcset="{{ $item->imagehome }}">
                                    <source media="(max-width: 480px)" srcset="{{ $item->imagehome }}">
                                    <img class="d-block img img-cover position-absolute category-img-zoom"
                                        src="{{ $item->imagehome }}" alt="{{ languageName($item->name) }}" />
                                </picture>
                                <div
                                    class="category-name-overlay position-absolute w-100 h-100 d-flex align-items-center justify-content-center">
                                    <div
                                    ...
                                    <span
                                        class="category-name-text text-white  text-uppercase">{{ languageName($item->name) }}</span>
                                </div>
                            </a>
                        </div>
                    @endforeach
       ...
       <div class="container">
        ...
        <section id="flash_sale" class="m_product mt-3 mt-lg-4 mb-3 mt-lg-4" data-aos="fade-up">
            ...
            <div class="container">
                <div class="rounded bg-flash modal-open p-2">
                    <h2 class="title12 text-uppercase font-weight-bold position-relative m-0 ">
                        <a class="position-relative cangiua pdt" title="SẢN PHẨM NỔI BẬT">
                            SẢN PHẨM NỔI BẬT
                        </a>
                        ...
                        <div class="uk-position-cover uk-padding-small ">
                            <img class="uk-position-top-left" src="{{ url('frontend/images/icon_top_left.png') }}"
                                alt="icon 1">
                            <img class="uk-position-top-right" src="{{ url('frontend/images/icon_top_right.png') }}"
                                alt="icon 2">
                            <img class="uk-position-bottom-left" src="{{ url('frontend/images/icon_bottom_left.png') }}"
                                alt="icon 3">
                            <img class="uk-position-bottom-right" src="{{ url('frontend/images/icon_bottom_right.png') }}"
                                alt="icon 4">
                            <div class="row">
        ...
        @foreach ($categoryhome as $key => $item)
            @if (count($item->product) > 0)
                <section id="product_3" class="m_product mt-3 mt-lg-4 mb-3 mt-lg-4" data-aos="fade-up"
                    ...
                    <div class="container">
                        <div class="rounded p-2">
                            <div
                                ...
                                <div class="title text-uppercase font-weight-bold position-relative m-0 tuanbf">
                                    <div class="title1__box1">
                                        ...
                                        <a style="color:white" class="position-relative textgiua"
                                            href="{{ route('allListProCate', ['danhmuc' => $item->slug]) }}"
                                            title="{{ languageName($item->name) }} NỔI BẬT">
                            ...
                            <div class="row align-items-lg-center">
                                @if ($key % 2 == 0)
                                    <div class="col-xl-2 col-lg-2 col-2 anmobile">
                                        <div style="width:100%; height:100%" class="tranh-danh-muc">
                                            <a href="{{ route('allListProCate', ['danhmuc' => $item->slug]) }}">

                                                <img src="{{ $item->imagehome }}" alt="" srcset=""
                                                    style="width:100%; height:361px; object-fit: cover;" class="img-cate">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-xl-10 col-lg-10 col-12 " data-aos="fade-left"
                                        data-aos-delay="{{ $key * 150 + 200 }}">
                                        <div
                                            class="mew_product_{{ $key }} swiper-container p-2 position-relative">
                                            <div class="swiper-wrapper">
                                ...
                                @else
                                    <div class="col-xl-10 col-lg-10 col-12" data-aos="fade-right"
                                        data-aos-delay="{{ $key * 150 + 200 }}">
                                        <div
                                            class="mew_product_{{ $key }} swiper-container p-2 position-relative">
                                            <div class="swiper-wrapper">
                ...
                <div class="container">
                    <div class="p-3">
                        <div
                            ...
                            <h2 class="title text-uppercase font-weight-bold position-relative m-0 ">
                                <div class="title1__box1">
                                    <a class="position-relative textgiua" style="color:white"
                                        href="{{ route('allListBlog') }}" title="Tin tức cập nhật">
                                        Tin tức cập nhật
                                    </a>
                                    <div class="uk-position-cover uk-padding-small ">
                                        <img class="uk-position-top-left"
                                ...
                                <div class="item_grid mb-3 mb-md-0">
                                    <div class="img_thm position-relative modal-open bor-10">
                                        <a href="{{ route('detailBlog', ['slug' => $hotnews[0]->slug]) }}"
                                            title="{{ languageName($hotnews[0]->title) }}" class="effect-ming">
                                            <div
                                                class="position-relative w-100 m-0 be_opa modal-open ratio3by2 has-edge aspect">
                                                <img src="{{ url('frontend/images/placeholder_1x1.png') }}"
                                    ...
                                    <div class="cont">
                                        <h3 class="title_blo font-weight-bold mt-2"><a class="line_1"
                                                ...
                                                title="{{ languageName($hotnews[0]->title) }}">{{ languageName($hotnews[0]->title) }}</a>
                                        </h3>
                                    ...
                                    @if ($key > 0)
                                        <article class="blog-item-list clearfix mb-3 row">
                                            <div class="col-4 col-lg-3 pr-0 ">
                                                <a href="{{ route('detailBlog', ['slug' => $item->slug]) }}"
                                                    ...
                                                    <span
                                                        ...
                                                        <img src="{{ url('frontend/images/placeholder_1x1.png') }}"
                                                            data-src="{{ $item->image }}" decoding="async"
                                            ...
                                            <div class="blogs-rights col-8 col-lg-9">
                                                ...
                                                <div class="post-time small">{{ date_format($item->created_at, 'd/m/Y') }}
                                                </div>
                                                <div class="sum line_2 h-auto text-justify">
