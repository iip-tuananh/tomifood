          ...
          <div class="card">
            <div class="card-body" >
                ...
                <!-- <div class="form-group">
                  ...
                  <image-upload type="avatar" v-model="objData.imgHeader" :title="'imgHeader'"></image-upload>
                </div>
                <div class="form-group">
                  <label>Link ảnh header</label>
                  <vs-input
                    type="text"
                    size="default"
                    class="w-100"
                    v-model="objData.linkImgHeader"
                  />
                </div>
                <div class="form-group">
                  <label>Trạng thái hiển thị ảnh header</label>
                  <vs-select v-model="objData.statusImgHeader"
                  >
                      <vs-select-item  value="1" text="Hiện" />
                      <vs-select-item  value="0" text="Ẩn" />
                    </vs-select>
